...
# Adapted from Synchformer: https://github.com/v-iashin/Synchformer
# Original Synchformer code: Copyright (c) 2024 Vladimir Iashin (MIT License).
# Includes portions derived from Motionformer:
#     https://github.com/facebookresearch/Motionformer
#     Copyright (c) Facebook, Inc. and its affiliates. All Rights Reserved.
#     (Licensed under CC BY-NC 4.0)
# See the NOTICE.txt file in the root of this source tree for the full upstream licenses.
#
# Modifications:
